# Agent Farm vs Agent Sandbox — Comparison

## TL;DR

| | **Agent Farm** | **Agent Sandbox** |
|---|----------------|-------------------|
| **Architecture** | ✅ Single WorldState, reducer, event log, deterministic | ❌ Many Zustand stores, UI and state can drift |
| **Feels alive** | ❌ Stub logic only; agents don’t move or talk | ✅ LLM-driven loop, movement, chat, learning |

**Goal:** Keep Farm’s architecture and add Sandbox-style life (movement, say/thought, LLM, learning) by expressing everything as **actions** and **WorldState**.
...
## 2. What “comes to life” in Sandbox

These are the things that make Sandbox feel alive and that Farm currently doesn’t have:
...
## 3. What Farm has that Sandbox doesn’t
...
## 4. How to add “life” to Farm without losing architecture
...
## 5. Suggested order to implement “life” in Farm
